                            ...
                            <div class="card card-plain">
                                ...
                                <div class="card-body">
                                    ...
                                    <fieldset>
                                        ...
                                        <div class="form-check form-check-info text-start ps-0">
                                            <!-- <input class="form-check-input" type="checkbox" value="" id="flexCheckDefault" name="flexCheckDefault" checked> -->
                                            <?= $this->Form->input('checkbox', ['required' => 'false', 'type' => 'checkbox', 'id' => 'flexCheckDefault', 'class' => 'form-check-input', 'checked']) ?>
                                ...
                                <div class="card-footer text-center pt-0 px-lg-2 px-1">
                                    <p class="mb-2 text-sm mx-auto">
                                        ...
                                        <?= $this->Html->link(__('Sign in'), ['controller' => 'Users', 'action' => 'signin'], ['class' => 'text-primary text-gradient font-weight-bold']) ?>
                                    </p>
                                </div>
                            </div>
                        </div>
