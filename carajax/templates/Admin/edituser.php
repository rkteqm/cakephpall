    ...
    <aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3   bg-gradient-dark" id="sidenav-main">
        ...
        <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
            <ul class="navbar-nav">
                ...
                <li class="nav-item">
                    <?= $this->Html->link('<div class="text-white text-center me-2 d-flex align-items-center justify-content-center"><i class="fa-solid fa-pen-to-square opacity-10"></i></div><span class="nav-link-text ms-1">Edit User</span>' . __(''), ['controller' => 'Admin', 'action' => 'edituser', $user->id], ['escape' => false, 'title' => __('Edit User'), 'class' => 'nav-link text-white active bg-gradient-primary']) ?>
                </li>
                <li class="nav-item">
                                ...
                                <div class="card card-plain">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="text-center">
                                            <?= $this->Form->button(__('Update'), ["class" => "btn btn-lg bg-gradient-primary btn-lg w-100 mt-4 mb-0"]) ?>
                                        </div>
                                        <?= $this->Form->end() ?>
                                    </div>
                                </div>
